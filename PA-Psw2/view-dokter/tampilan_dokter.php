    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
         ...
         <li><a class="nav-link scrollto" href="jadwal.php">Schedule</a></li>
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 mt-4">
            <div class="card brder-dark">
              <img src="../asset/img/<?php echo $result['gambar'] ?>" class="card-img-top" widht="150 px">
              <div class="card-body">
              <h4 class="card-title font-weight-bold"><?php echo $result['nama_dokter'] ?></h4>
                <h6 class="card-title "><?php echo $result['deskripsi'] ?></h6>
                <a href="jadwal.php"class="btn btn-success btn-sm " >Detail</a>
              </div>
            </div>
          </div>
          <?php endforeach; ?>
