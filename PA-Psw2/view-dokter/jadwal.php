    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
         ...
         <li><a class="nav-link scrollto active" href="jadwal.php">Schedule</a></li>
                            ...
                            <table class="table table-bordered datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-icon icon-left btn-success" href="editjadwal.php?id=<?=$row["id"];?>">Edit</a>
                                            <a class="btn btn-icon icon-left btn-danger" href="hapusjadwal.php?id=<?=$row["id"];?>" onclick="return confirm('Yakin ingin menghapus data ini ?')">Delete</a>
                                        </td>
                                    </tr>
                                    <?php $i++ ;?>
                                    <?php endforeach; ?>
                        ...
                        <div class="card-body">
                            ...
                            <thead>
                                ...
                                include "../controller/koneksiKonsul.php";
                                  ...
                                  $ambildata = mysqli_query($koneksi, "select * from daftar_konsul");
                                while ($tampil = mysqli_fetch_array($ambildata)) {
                                 echo "
                                  <tr>
                                  <td>$tampil[nama_pasien]</td>
                                  <td>$tampil[email_pasien]</td>
                                  <td>$tampil[no_hp]</td>
                                  <td>$tampil[umur_pasien]</td>
